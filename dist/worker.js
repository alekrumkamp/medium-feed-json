/******/ (function(modules) {
  ...
  /******/ [
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      class GraphqlFeedController {
        ...
        adaptPosts(response, userImage) {
          ...
          const nextPagingInfo =
            response.data.user.latestStreamConnection.pagingInfo;
          const nextId =
    ...
    /***/ function(module, exports) {
      exports.graphqlRequestBody = function graphqlRequestBody(
        userId,
        to,
        limit
      ) {
      ...
      class UserController {
        ...
        getUserId() {
          return fetch(this.getUserPath())
            .then(response => response.json())
            .then(jsonResponse =>
              this.extractIdFromString(jsonResponse.feed.link)
            );
        }
      }
